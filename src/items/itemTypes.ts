...
export type ItemId = 'purple_ball' | 'wind_ball' | 'white_ball' | 'gold_ball' | 'smiley_face' | 'extra_life';
...
export const ITEM_DEFS: ItemDef[] = [
  ...
  { id: 'extra_life', name: 'Extra Life', rarity: 'legendary', color: '#44ff44', symbol: '\u2764' },
];
